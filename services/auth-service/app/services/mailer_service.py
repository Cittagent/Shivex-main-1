...
class MailerService:
    ...
    async def send_invite_email(self, *, recipient: str, full_name: str | None, invite_link: str) -> None:
        ...
        subject = "Your FactoryOPS invitation"
        text = (
            f"Hello {greeting},\n\n"
            "You have been invited to FactoryOPS. Use the link below to set your password. "
        ...
        html = (
            ...
            "<p>You have been invited to FactoryOPS. Use the link below to set your password.</p>"
    ...
    async def send_password_reset_email(self, *, recipient: str, full_name: str | None, reset_link: str) -> None:
        greeting = full_name or recipient
        subject = "Reset your FactoryOPS password"
        text = (
            f"Hello {greeting},\n\n"
            "We received a request to reset your FactoryOPS password. "
        ...
        html = (
            "<html><body>"
            f"<p>Hello {greeting},</p>"
            "<p>We received a request to reset your FactoryOPS password.</p>"
